...
public class RegistrationPage extends Utility {
    ...
    @FindBy(xpath = "//body[1]/div[6]/div[1]/div[1]/div[2]/div[1]/ul[1]/li[1]/a[1]")
    ...
    public void navigateToRegistrationLink() throws InterruptedException {
      Thread.sleep(4000);
      mouseHoverToElement(registrationLink);
